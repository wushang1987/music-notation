        ...
        <aside className="w-64 bg-white border-r border-gray-200 h-full overflow-y-auto z-10 hidden md:block shrink-0">
            <div className="p-6">
                ...
                <nav className="space-y-1">
                    ...
                    <Link to="/albums" className={`flex items-center px-4 py-3 rounded-lg transition-all duration-200 text-sm font-medium ${isActive('/albums')}`}>
                        <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19V6l12-2v13" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 10l12-2" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 21a2 2 0 100-4 2 2 0 000 4z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 19a2 2 0 100-4 2 2 0 000 4z" /></svg>
